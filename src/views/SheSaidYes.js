    ...
    <StyledXYearsLater className="clearfix">
      <StyledBackgroundOverlay>
        ...
        >
          <StyledBackgroundImage
            title="House"
            placeholder="/img/photos/living_room.jpeg"
            image="/img/photos/living_room.jpeg"
            isCover
            isVisible={isVisible}
          />
        </ParallaxLayer>
      ...
      <ParallaxLayer offset={baseFactor * 0.4} speed={0.1} factor={baseFactor}>
        ...
        >
          ...
          >
            4 years into dating, on November 21, 2019, Jarin proposed at
            Hannah's house in front of her family and friends.
            <br />
            <br />
      ...
      >
        <StyledProposalImageContainer>
          <StyledProposalImageLoader
            ...
            placeholder="/img/photos/engagement.jpg"
            image="/img/photos/engagement.jpg"
            isCover
            isVisible={isVisible}
          />
        </StyledProposalImageContainer>
        ...
        >
          <StyledRingImageContainer>
            <StyledRingImageLoader
              ...
              placeholder="/img/photos/the_ring.jpg"
              image="/img/photos/the_ring.jpg"
              isCover
              isVisible={isVisible}
            />
          </StyledRingImageContainer>
