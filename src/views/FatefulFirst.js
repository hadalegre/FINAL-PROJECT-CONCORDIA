...
const StyledFatefulFirst = styled.div`
...
const FatefulFirst = ({ baseFactor, isVisible }) => {
  return (
    <StyledFatefulFirst className="clearfix">
      <StyledBackgroundOverlay>
        ...
        >
          <StyledBackgroundImage
            title="Hannah and Jarin - Coffee Shop"
            placeholder="/img/photos/background.jpg"
            image="/img/photos/background.jpg"
            isCover
            isVisible={isVisible}
          />
        </ParallaxLayer>
      ...
      <ParallaxLayer offset={baseFactor * 0} speed={0.1} factor={baseFactor}>
        ...
        >
          ...
          >
            Hannah and Jarin first met at their part-time job in 2014. That day, Jarin was accompanied by their common friend for his interview while Hannah just finished her shift. 
            They got introduced to each other and talked for couple of hours until it's time to say goodbye. They never had a shift together but somehow remained friends even on Facebook. 
