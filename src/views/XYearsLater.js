...
const imageColumns = [
  [
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Portugal",
      name: "img_1"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Schiphol",
      name: "img_2"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - NY",
      name: "img_3"
    }
  ],
  [
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Going to Amsterdam",
      name: "img_4"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Barcelona",
      name: "img_5"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Quebec City",
      name: "img_6"
    }
  ],
  [
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Mont Tremblant",
      name: "img_7"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Skiing",
      name: "img_8"
    },
    {
      id: shortid.generate(),
      alt: "Hannah and Jarin - Attending Wedding in Ottawa",
      name: "img_9"
    }
  ]
];
    ...
    <StyledXYearsLater className="clearfix">
      <StyledBackgroundOverlay>
        ...
        >
          <StyledBackgroundImage
            title="Cabo de Roca"
            placeholder="/img/photos/adventures.jpg"
              ...
              <StyledGridColumn key={i}>
                {column.map((image, j) => (
                  <ImageLoader
                    key={image.id}
                    title={image.title}
                    placeholder={`/img/photos/${image.name}.jpg`}
                    image={`/img/photos/${image.name}.jpg`}
                    width="100%"
                    height="100%"
                    borderRadius="0.25em"
                    isVisible={isVisible}
      ...
      >
        ...
        >
          ...
          >
            Hannah and Jarin immediately connected as their shared love for
            family, friends, food and travel began to shape the relationship they have
            today. Their early years formed the foundation of their relationship
            - from early hikes and late night flights, impromptu dates and long drives, and surprise
            food trips to first jobs and promotions and living together, to making more memories.
          </StyledText>
        </StyledSkewPanel>
      </ParallaxLayer>
    </StyledXYearsLater>
