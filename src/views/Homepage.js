...
const description =
  "The wedding ceremony of Hannah and Jarin will take place November 21, 2020 in Rigaud, Quebec. Family and friends, join us as we celebrate an important milestone of our lives.";
...
const Homepage = ({ handleIsBrandDark, handleIsNavbarDark }) => {
  ...
  return (
    <StyledMain>
      <Helmet>
        <title>Hannah and Jarin's Wedding - Homepage</title>
      ...
      >
        <StyledGraphic src="/img/graphics/cover.png" />
      </StyledHero>
    </StyledMain>
  );
};
