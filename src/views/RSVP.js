...
const description =
  "RSVP to Hannah and Jarin's wedding. Please reply back with the following pieces of information by September 1: first name, last name, e-mail address, a list of guests and a message to the couple.";
...
class RSVP extends Component {
  ...
  render() {
    ...
    return (
      <StyledMain>
        <Helmet>
          <title>Hannah and Jarin's Wedding - RSVP</title>
          <meta name="description" content={description} />
          <meta content={description} property="og:description" />
        </Helmet>
        <StyledPageHeaderImage src="/img/photos/rsvp.jpg">
        ...
        <StyledPageSection>
          ...
          <StyledSubDescription>
            KINDLY RESPOND BY OCTOBER 15, 2020
          </StyledSubDescription>
          <StyledRSVPForm
            noValidate
